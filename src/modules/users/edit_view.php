...
<form method="POST" action="index.php?page=users/handle_edit" class="ajax-form">
    ...
    <div class="modal-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-12"><div class="form-check"><input class="form-check-input" type="checkbox" name="is_active" value="1" id="is_active" <?= ($user['is_active']) ? 'checked' : '' ?>><label class="form-check-label" for="is_active">المستخدم نشط</label></div></div>
        </div>
    </div>
