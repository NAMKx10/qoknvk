...
<form method="POST" action="index.php?page=properties/handle_add" class="ajax-form">
    <div class="modal-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label">نوع العقار</label><select class="form-select select2-init" name="property_type"><option value="">اختر النوع...</option><?php foreach($property_types as $pt):?><option value="<?=$pt?>"><?=htmlspecialchars($pt)?></option><?php endforeach;?></select></div>
