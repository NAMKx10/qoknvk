...
// الإصدار الاحترافي والمُعاد هيكلته للعمل مع الموجّه المركزي
...
elseif ($page === 'settings/handle_edit_lookup_group_ajax') {
    ...
    // تحديث سجل اسم المجموعة نفسه (مع تصحيح لـ subquery لضمان التوافق)
...
// ملاحظة: معالجات الحذف التي تعتمد على إعادة التوجيه header() يجب أن تبقى في index.php
// لأنها ليست طلبات AJAX ولا ترجع JSON.
?>